...
public class DashboardController  implements Initializable {
    ...
    public ImageView imgRegisterActors;
    @FXML
    ...
    public void imgRegisterActors_OnMouseClicked(MouseEvent mouseEvent) throws IOException {
    ...
    public void imgManageMovie_OnMouseClicked(MouseEvent mouseEvent) throws IOException {
